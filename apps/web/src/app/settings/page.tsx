                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className={`w-12 h-6 rounded-full transition-colors ${
                            emailNotifications ? "bg-blue-600" : "bg-muted"
                          }`}
                        >
                          <div
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className={`w-12 h-6 rounded-full transition-colors ${
                            smsNotifications ? "bg-blue-600" : "bg-muted"
                          }`}
                        >
                          <div
                            className={`w-4 h-4 bg-white rounded-full transition-transform ${
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className={`w-12 h-6 rounded-full transition-colors ${
                            pushNotifications ? "bg-blue-600" : "bg-muted"
                          }`}
                        >
                          <div
                            className={`w-4 h-4 bg-white rounded-full transition-transform ${
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className={`w-12 h-6 rounded-full transition-colors ${
                            caseUpdates ? "bg-blue-600" : "bg-muted"
                          }`}
                        >
                          <div
                            className={`w-4 h-4 bg-white rounded-full transition-transform ${
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className={`w-12 h-6 rounded-full transition-colors ${
                            billingAlerts ? "bg-blue-600" : "bg-muted"
                          }`}
                        >
                          <div
                            className={`w-4 h-4 bg-white rounded-full transition-transform ${
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className={`w-12 h-6 rounded-full transition-colors ${
                            calendarReminders ? "bg-blue-600" : "bg-muted"
                          }`}
                        >
                          <div
                            className={`w-4 h-4 bg-white rounded-full transition-transform ${
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className={`w-12 h-6 rounded-full transition-colors ${
                            twoFactorAuth ? "bg-blue-600" : "bg-muted"
                          }`}
                        >
                          <div
                            className={`w-4 h-4 bg-white rounded-full transition-transform ${
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className={`w-12 h-6 rounded-full transition-colors ${
                            dataSharing ? "bg-blue-600" : "bg-muted"
                          }`}
                        >
                          <div
                            className={`w-4 h-4 bg-white rounded-full transition-transform ${
